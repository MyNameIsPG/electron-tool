  ...
  <div class="container">
    ...
    <div class="select-table-data">
      ...
      >
        <el-table-column type="selection" width="55"> </el-table-column>
        <el-table-column type="index" width="50"></el-table-column>
        <el-table-column prop="tableSchema" label="表名称" sortable>
        </el-table-column>
        <el-table-column prop="columnName" label="数据库字段"> </el-table-column>
        <el-table-column prop="columnComment" label="字段描述"> </el-table-column>
        <el-table-column prop="dataType" label="数据库类型"> </el-table-column>
        <el-table-column prop="columnKey" label="主键"> </el-table-column>
      </el-table>
    </div>
  </div>
</template>
