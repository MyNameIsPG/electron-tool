  ...
  <div class="container">
    ...
    <div class="select-table-data">
      ...
      >
        ...
        <el-table-column prop="javaType" label="java 类型" width="140">
        </el-table-column>
        ...
        <el-table-column prop="isInsert" label="新增" width="100">
          <template slot-scope="scope">
            <el-checkbox v-model="scope.row.isInsert"></el-checkbox>
          </template>
        </el-table-column>
        <el-table-column prop="isEdit" label="编辑" width="100">
          <template slot-scope="scope">
            <el-checkbox v-model="scope.row.isEdit"></el-checkbox>
          </template>
        </el-table-column>
        <el-table-column prop="isList" label="列表" width="100">
          <template slot-scope="scope">
            <el-checkbox v-model="scope.row.isList"></el-checkbox>
          </template>
        </el-table-column>
        <el-table-column prop="isQuery" label="查询" width="100">
          <template slot-scope="scope">
