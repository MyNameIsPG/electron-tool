...
function getDataBaseTable (win) {
  return new Promise(() => {
    const sql = `SELECT table_name as tableName, table_comment as tableComment, create_time as createTime FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'cloudcity'`
